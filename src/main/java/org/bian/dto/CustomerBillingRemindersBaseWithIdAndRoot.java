...
/**
 * CustomerBillingRemindersBaseWithIdAndRoot
 */
public class CustomerBillingRemindersBaseWithIdAndRoot   {
  private String customerBillingReminderReference = null;
   ...
   * @return customerBillingReminderReference
  **/

  public String getCustomerBillingReminderReference() {
    return customerBillingReminderReference;
  }

  public void setCustomerBillingReminderReference(String customerBillingReminderReference) {
    this.customerBillingReminderReference = customerBillingReminderReference;
  }
